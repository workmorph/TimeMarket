...
import { Mail, Lock, Eye, EyeOff, Github, Loader2, AlertCircle, Gavel } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">専門家の時間をオークションで取引</p>
        </div>
        ...
        <Card className="border-yellow-200 bg-yellow-50">
          <CardContent className="pt-4">
            <h4 className="text-sm font-medium text-yellow-800 mb-2">デモ用テストアカウント</h4>
