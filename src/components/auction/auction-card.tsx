              ...
              <CardHeader>
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <Badge variant="outline">
                      {auction.delivery_method === "online"
                        ? "オンライン"
                ...
                <CardTitle className="text-2xl leading-tight">{auction.title}</CardTitle>
              ...
              <CardContent>
                <div className="flex items-start space-x-4">
                  <Avatar className="w-16 h-16">
                    <AvatarImage
                      src={auction.expert.avatar_url}
                      alt={auction.expert.display_name}
                    />
                ...
                <div className="space-y-3">
                  {bids.map((bid, index) => (
                    <div key={bid.id} className="flex items-center justify-between py-2">
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${index === 0 ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-600"}`}
                        >
                          {index + 1}
                        </div>
                        <div>
